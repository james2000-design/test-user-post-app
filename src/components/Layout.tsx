...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen w-full">
      <Navbar />
      <SideBar />
      <main className="px-10 ml-[120px] mt-15 w-full">
          ...
          <div className="w-full ">
            <div className="flex flex-wrap justify-center space-y-4 sm:space-y-0  sm:items-center sm:justify-between border-gray-300  border-b-[1.5px] pb-4 ">
              ...
              <div className="flex items-center justify-between flex-nowrap overflow-x-scroll space-x-2">
                ...
                <label className="inline-flex items-center px-2 py-2 rounded-md hover:bg-gray-50 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
                  <span className="ml-2  text-sm flex flex-nowrap">
                    Auto refresh
                  </span>
                </label>
              </div>
